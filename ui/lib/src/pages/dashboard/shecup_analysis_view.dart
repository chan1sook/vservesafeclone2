...
class ShecupAnalysisDashboardView extends StatefulWidget {
  const ShecupAnalysisDashboardView({
    super.key,
  ...
  static const routeName = '/shecup-analysis';

  @override
  State<ShecupAnalysisDashboardView> createState() =>
      _ShecupAnalysisDashboardViewState();
}

class _ShecupAnalysisDashboardViewState
    extends State<ShecupAnalysisDashboardView> {
  int _pageIndex = 0;
